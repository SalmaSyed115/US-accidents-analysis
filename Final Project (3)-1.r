...
lzn.vgm = variogram(log(df_for_Kriging_model.Severity) ~ df_for_Kriging_model.Start_Lng+ df_for_Kriging_model.Start_Lat , train_df, width=0.1)
plot(lzn.vgm)
